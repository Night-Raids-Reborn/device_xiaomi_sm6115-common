...
ifneq (,$(filter odm, $(BOARD_QTI_DYNAMIC_PARTITIONS_PARTITION_LIST)))
...
# Power
TARGET_POWER_FEATURE_EXT_LIB := //$(COMMON_PATH):libpowerfeature_ext_bengal
...
# Sepolicy
include device/xiaomi/sm6115-common/sepolicy/sm6115-common-sepolicy.mk
